...
def write_ranks_into_file():
    ranks = read_in_embeddings_return_frequency_rank_dict("/home/skrjanec/rewrite_text/data_auxiliary/cc.de.300.vec")
    with open("/home/skrjanec/rewrite_text/data_auxiliary/frequency_ranks_de.json", "w") as fout:
...
def load_ranks(lang):
    ...
    if lang == "de":
        with open("/home/skrjanec/rewrite_text/data_auxiliary/frequency_ranks_de.json") as fin:
            ranks = json.load(fin)
        return ranks
    with open("/home/skrjanec/rewrite_text/data_auxiliary/frequency_ranks_en.json") as fin:
        ranks = json.load(fin)
    return ranks
